...
const heracles = new Hero("👨 Heracles", 20, 6, "./images/heracles.svg", 7, 5);
...
const bird1 = new Monster("Bird", 25, 12, "./images/bird.svg", 5, 8);
const bird2 = new Monster("Bird", 25, 12, "./images/bird.svg", 1, 1);
...
const lake = new Arena(heracles, birds);
const ArenaHTML = new ArenaTemplate("arena");
ArenaHTML.createArena(lake);
